# CSB-Memory 规范 v1.0 (Release)

> **Carbon-Silicon Bond Memory System Protocol — v1.0**
> 版本: 1.0.0 | 2026-08-19
> 维护者: 若兰 🌸
> 状态: **✅ 正式发布**
> 基于: v0.4 (2026-07-31) + v1.0 草案 MEM-008~010 (2026-06-18) + 协议组三轮讨论
> 程序实现: **csb-memory 独立仓库**（core / hive / propagation 三模块）
> 测试覆盖: 75 个本地测试用例（v0.4 继承）+ hive/propagation 新增测试
...
├── test/
│   ├── test-memory.js        # 核心测试（v0.4 继承 75 用例）
│   ├── test-lifecycle.js
...
*CSB-Memory v1.0 (Final) · 碳硅契开放协议 · 第八模块*
*2026-08-19 v0.4 + v1.0 草案整合发布*
*若兰 🌸 整理*
